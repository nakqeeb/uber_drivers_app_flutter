...
class _NotificationDialogBoxState extends State<NotificationDialogBox> {
  ...
  _acceptRideRequest(BuildContext context) {
    ...
    FirebaseDatabase.instance
      ...
      if (snap.snapshot.value != null) {
        ...
        Fluttertoast.showToast(msg: 'This ride request is not existed anymore');
      }

      if (getRideRequestId == widget.userRideRequestDetails!.rideRequestId) {
        // update newRideStatus from rideRequestId to accepted
        FirebaseDatabase.instance
            .ref()
            .child('drivers')
            .child(currentFirebaseUser!.uid)
        ...
        // trip strted now - send driver to new TripScreen
        Navigator.push(
            context,
            MaterialPageRoute(
              builder: (ctx) => NewTripScreen(
                  userRideRequestDetails: widget.userRideRequestDetails),
            ));
      } else {
        Fluttertoast.showToast(
            msg: 'This ride request is not existed anymore.');
      }
    });
  }
}
